...
module.exports = {
  ...
  // your email being exposed in public.kang
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'CoderKang@kang1121.onmicrosoft.com',
